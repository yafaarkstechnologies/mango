    ...
    <section className="relative w-full py-32 bg-[#050505] overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="p-16 md:p-24 rounded-[4rem] bg-gradient-to-b from-white/[0.05] to-transparent border border-white/5 relative"
        >
          ...
          <p className="text-2xl md:text-3xl text-white/50 font-light leading-relaxed mb-12">
          ...
          <div className="inline-flex items-center gap-4 px-8 py-3 rounded-full bg-white/5 border border-white/10 text-yellow-500 font-bold uppercase tracking-widest text-xs">
        ...
        <div className="mt-32 space-y-12">
            ...
            <div className="flex flex-col items-center gap-8">
                ...
                <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-[10px] uppercase tracking-[0.4em] font-black text-white/20">
